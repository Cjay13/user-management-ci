...
sed -i "s/SERVICE_PORT/v${SERVICE_PORT}/g" ${DEPLOYMENT_FILE}

sed -i "s/SERVICE_NAME/${SERVICE_NAME}/g" ${SERVICE_FILE}
sed -i "s/SERVICE_PORT/v${SERVICE_PORT}/g" ${SERVICE_FILE}

sed -i "s/SERVICE_NAME/${SERVICE_NAME}/g" ${INGRESS_FILE}
sed -i "s/INGRESS_HOST/v${INGRESS_HOST}/g" ${INGRESS_FILE}
sed -i "s/PATH_NAME/v${PATH_NAME}/g" ${INGRESS_FILE}
